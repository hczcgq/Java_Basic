...
public class LubarDate {
	 ...
	 // ====== 传回农历 y年的总天数
	     ...
	     * 传出y年m月d日对应的农历
	     * yearCy:农历年与1864的相差数  
	     * monCy:从1900年1月31日以来,闰月数 
		 * dayCy:与1900年1月31日相差的天数,再加40　　　
	     */
	    public LubarDate(Calendar cal) {
	    ...
	    public static void main(String[] args) throws ParseException {
	        ...
	        today.setTime(chineseDateFormat.parse("2016年5月20日"));
	        LubarDate lunar = new LubarDate(today);
